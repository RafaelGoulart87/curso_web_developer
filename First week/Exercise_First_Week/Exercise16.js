/*
06 - Um banco vai liberar linhas de crédito só para servidores públicos. Caso o(a)
...
if (servidor === false && professor === true) {
    console.log(name + " infelizmente você não tem linha de crédito disponivel.")

} else if (servidor === true && professor === true) {
    console.log("Parabens " + name + "! Você tem acesso a nossa linha de crédito especial.")

} else {
    console.log(name + ", você tem acesso a nossa linha de credito para servidores.")
}